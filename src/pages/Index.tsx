...
const Index = () => {
  ...
  const льготы = [
    ...
    { title: "Социальный проездной", description: "Позволяет оплачивать разовые поездки со скидкой 50% на городских маршрутах и 60% на пригородных.", tags: ["Транспорт", "Студенты"] },
