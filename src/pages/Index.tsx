...
const Index = () => {
  ...
  const спорт = [
    { title: "Футбольная секция", description: "Тренировки 3 раза в неделю", location: "Академия Арктика", age: "16-25 лет" },
    { title: "Плавание", description: "Бассейн олимпийского стандарта", location: "Плавательный бассейн", age: "14-30 лет" },
    { title: "Самбо", description: "Профессиональная подготовка", location: "Ирбис", age: "18-35 лет" },
    { title: "Йога и фитнес", description: "Групповые занятия", location: "Спортивный клуб Волна", age: "16+" }
  ];
